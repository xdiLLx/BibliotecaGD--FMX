...
uses
  ...
  GD.Types, FMX.Forms, System.Types, WinApi.ShellApi, WinApi.Windows,
  WinApi.Messages;
...
begin
  ...
  begin
    ...
    begin
      ...
      FChildColorBackup[High(FChildColorBackup)] := TLabel(Self.Children[i])
        .FontColor;
...
procedure TGDCornerButton.TrayWndProc(var Message: TMessage);
begin
