...
type
  ...
  published
    ...
    property CounterVisible: Boolean read FCounterVisible
      write SetCounterVisible default True;
    property CounterDiameter: Single read FCounterDiameter
      write SetCounterDiameter;
...
begin
  ...
  begin
    ...
    Repaint;  // Force o componente a se redesenhar
  end;
end;
